...
function Header() {
  ...
  return (
    <header className="bg-none text-red p-4 flex flex-col md:flex-row items-center justify-center w-full sticky top-0">
      <div className="flex justify-between w-full">
        <div className="flex flex-row">
          ...
          <div>
            <Link href="/" passHref>
              <span className="font-bold text-lg ml-2">Whales Flow</span>
            </Link>
          </div>
        </div>
        ...
        <button
          ...
          className="md:hidden lg:hidden xl:hidden flex items-center mr-4"
          id="burger"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        {isExpanded && (
          <div className="bg-gray-400 rounded-lg px-7 py-2">TEST</div>
        )}
      </div>
      ...
      >
        ...
        <Link href="/Pricing" passHref>
          <div className="hover:text-gray-300 cursor-pointer">Pricing</div>
        </Link>
        <Link href="/Blog" passHref>
          <div className="hover:text-gray-300 cursor-pointer">Blog</div>
        </Link>
        <Link href="/Academy" passHref>
          <div className="hover:text-gray-300 cursor-pointer">Academy</div>
        </Link>
        <Link href="/FAQs" passHref>
          <div className="hover:text-gray-300 cursor-pointer">FAQs</div>
        </Link>
        <ThemeToggle />
      </nav>
      ...
      <div className="flex flex-row space-x-2 pl-5">
        <div>
          <button className="border-2 border-sky-600 text-green px-7 py-2 hover:bg-sky-700 hover:text-white">
            Login
          </button>
        </div>
        <div>
          <button className="bg-sky-600 border-2 border-sky-600 text-white px-3 py-2 hover:bg-sky-700 text-nowrap">
            Start Trial
          </button>
        </div>
      </div>
